...
// import 'package:flutter/painting.dart' show ImageChunkEvent, ImageStreamCompleter, MultiFrameImageStreamCompleter;
...
// @immutable
// class CacheImage extends image_provider.ImageProvider<image_provider.NetworkImage>
...
//
//   @override
//   Future<CacheImage> obtainKey(image_provider.ImageConfiguration configuration) {
...
//       codec: _loadAsync(key as CacheImage, decode, chunkEvents),
//       scale: key.scale,
//       debugLabel: key.url,
...
//             DiagnosticsProperty<CacheImage>('Image key', key as CacheImage),
//           ];
//       return true;
//     }());
//     return collector;
...
//               throw image_provider.NetworkImageLoadException(statusCode: status, uri: resolved);
//             }
//           }.toJS);
//
